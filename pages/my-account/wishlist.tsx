...
export default function wishlist () {
    ...
    const [productAmount, setProductAmount] = useState<{ [sku_id: string]: string }>({});
    ...
    const handleCheckboxChange = (index: string | number) => (event: { target: { checked: boolean; }; }) => {
    ...
    const handleProductAmountChange = (product: { sku_id: string; }, quantity: string) => {
            ...
            <div className={styles.mainContent}>
                ...
                <div className={styles.listsProductsContainer}>
                    ...
                    <select className={styles.listSelection} onChange={handleListChange}>
                        {[...new Set(filteredLists.map((list: { list_name: string; }) => list.list_name))].map((listname: string) => (
                                    ...
                                    <div className={styles.detailWrapper}>
                                        ...
                                        <div className={styles.quantity}>
                                            ...
                                            <input
                                                ...
                                                type='text'
                                                onChange={(e) => handleProductAmountChange({ sku_id: '123' }, e.target.value)}
                                                defaultValue="1"
                                            />
                                        </div>
                                        <button  
