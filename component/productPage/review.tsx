...
export default function Review() {
    ...
    const handleVoteClick = async (review_id: string) => {
        try {
    ...
    const handleRankReview = (review_score: number) => {
        ...
        <div className={styles.reviewContainer}>
            ...
            <div className={styles.reviewContainer}>
                {reviews && reviews.length > 0 ? (
                    reviews
                        .filter(rv => selectedRank === null || rv.review_score === selectedRank)
                        .slice(0, showAllReviews ? reviews.length : maxReviews)
                        .map((rv) => (
